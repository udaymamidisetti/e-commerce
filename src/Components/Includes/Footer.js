      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
              ...
              <div className="max-w-lg mx-auto">
                ...
                <dl className="mt-8 text-base text-gray-200">
                  <div>
                    ...
                    <dd>
                      <p>E-commerce 1/602,“C” Wing, Akshata APartments, </p>
                  ...
                  <div className="mt-6">
                    ...
                    <dd className="flex">
                      ...
                      />
                      <span className="ml-3">
                        <a href="tel:+919372457898">+91-93724-57898</a>
                      </span>
                    </dd>
                  </div>
                  <div className="mt-3">
                    ...
                    <dd className="flex">
                      ...
                      />
                      <span className="ml-3">
                        <a href="mailto:helpdesk@kazaricollection.com">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; {new Date().getFullYear()} E-COMMERCE PRIVATE LIMITED. All
            rights reserved.
          </p>
        </div>
      </div>

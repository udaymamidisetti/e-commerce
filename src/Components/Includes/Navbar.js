...
function Navbar() {
  ...
  const { cartLoading, cart, itemCount } = useSelector(
    (item) => item.cartReducer
  );
  ...
  return (
    <>
      {loading ? (
        ...
        <Disclosure
          as="header"
          className="bg-white shadow z-full fixed w-full "
        >
          {({ open }) => (
            <>
                    ...
                    <Menu as="div" className="flex-shrink-0 relative ml-4">
                      <div>
                        <Menu.Button className="bg-white rounded-full flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-kazari-500">
                          ...
                          {cart.length != 0 ? (
                            <span className=" absolute -top-1 left-0 items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-kazari-100 text-white">
                              {" "}
                              {cart[0]?.cart_items.length}{" "}
                            </span>
                          ) : (
                            ""
                          )}
                          <ShoppingCartIcon
                            onClick={checkLogin}
                            className="h-8 w-8 p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-full"
                            alt=""
                          />
                        </Menu.Button>
                      </div>

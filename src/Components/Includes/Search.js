      ...
      <Combobox value={selected} onChange={productClick}>
        <div className="relative mt-1">
          ...
          <Transition
            ...
            afterLeave={() => setQuery("")}
          >
            <Combobox.Options className="absolute mt-1 max-h-[50vh] -left-[12vw] w-[40vw] overflow-auto rounded-md bg-white  py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-full  [&::-webkit-scrollbar]:hidden">
                  ...
                  <Combobox.Option
                    ...
                    className={({ active }) =>
                      `relative cursor-default select-none py-2 pl-10 pr-4 ${
                        active ? "bg-kazari-600 text-white" : "text-gray-900"
                      }`
                    }
                    value={product}
                  >
                    {({ selected, active }) => (
                      <Link to={"/products/" + product._id}>
                        <div className="grid grid-cols-5 gap-4">
                          <div className="">
                            <img
                              className="max-w-full h-[10vh] mx-auto object-center object-contain"

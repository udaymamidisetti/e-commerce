    ...
    return (
        <form ref={addressForm}>
            <div className={open ? "hidden" : ""}>
                <RadioGroup defaultValue={selectedDeliveryMethod} onChange={handleChange}>
                    <RadioGroup.Label className="text-lg font-medium text-gray-900">Select from Saved Address
                        <span className="float-right">
                            {selectedDeliveryMethod &&
                                <button
                                    className="relative inline-flex items-center rounded-md border border-gray-300 bg-kazari-600 px-4 py-2 text-sm font-medium text-white hover:bg-kazari-50"
                                    onClick={handleEdit}
                                >
                                    Edit
                                </button>
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                        ...
                        <div className={classNames(
                            ...
                            <div className=' flex items-center mx-auto'>
                                ...
                                }} className="font-medium text-kazari-600"> Add Delivery Address</div>
                            </div>
                        </div>
                    </div>
                </RadioGroup>
            </div>
            {address && addressPagination.pagesCount > 1 && <div className={open ? "hidden" : "w-full max-w-2xl mx-auto lg:max-w-none lg:mt-0 lg:col-span-4"}>
                <nav
                ...
                <div className="mt-4">
                    ...
                    <div className="mt-1">
                        <input
                            ...
                            name="email"
                            autoComplete="email"
                            defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.email : ""}
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.first_name : ""}
                                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.last_name : ""}
                                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.address : ""}
                                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                name="apartment"
                                id="apartment"
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.apartment : ""}
                                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.city : ""}
                                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.state : ""}
                                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.pincode : ""}
                                className=" w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-1">
                            <input
                                ...
                                id="phone"
                                autoComplete="tel"
                                defaultValue={selectedDeliveryMethod ? selectedDeliveryMethod.phone : ""}
                                className="block w-full border-gray-300 rounded-md shadow-sm focus:ring-kazari-500 focus:border-kazari-500 sm:text-sm"
                            />
                        </div>
                    </div>

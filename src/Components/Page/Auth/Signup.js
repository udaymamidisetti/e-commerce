                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    ...
                    <div className="absolute inset-y-0 right-0 flex py-1.5 pr-1.5">
                      ...
                      <button
                        onClick={handleOTP}
                        className="inline-flex items-center border focus:border-kazari-500 border-gray-200 rounded px-2 text-sm font-sans font-medium text-gray-600"
                      >
                        Verify
                      </button>
                    </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link
                    ...
                    className="font-medium text-kazari-600 hover:text-kazari-500"
                  >
              ...
              <div className="mt-6 grid grid-cols-1 gap-3">
                <div className="flex justify-center" id="signUpDiv">
                  <Link className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                    ...
                    <span className=" text-kazari-600">

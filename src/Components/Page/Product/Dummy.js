                ...
                <div className="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
                    ...
                    <div className="max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
                            ...
                            <button
                                type="button"
                                className="w-full bg-kazari-50 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-kazari-700 hover:bg-kazari-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-kazari-500"
                            >
                                Preview
                            </button>
                        </div>
                        ...
                        <div className="border-t border-gray-200 mt-10 pt-10">
                            ...
                            <p className="mt-4 text-sm text-gray-500">
                                {license.summary}{' '}
                                <a href={license.href} className="font-medium text-kazari-600 hover:text-kazari-500">
                                    Read full license
                                </a>
                            </p>
                        </div>

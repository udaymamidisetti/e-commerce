            ...
            <section aria-labelledby="category-heading" className="bg-gray-50">
              <div className="max-w-7xl mx-auto py-8 px-4 sm:py-12 sm:px-6 lg:px-8">
                <div className="sm:flex sm:items-baseline sm:justify-between">
                  ...
                  <Link
                    to="/products"
                    className="hidden text-sm font-semibold text-kazari-600 hover:text-kazari-500 sm:block"
                  >
              ...
              <div className="relative bg-gray-800 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
                ...
                <div className="relative max-w-3xl mx-auto flex flex-col items-center text-center">
                  ...
                  <p className="mt-3 text-xl text-white">
                    E-commerce is a trademark registered company. Established in
                    2019, E-commerce is a platform for customers to buy unique
                    and hand-made home décor items along with apparel and
                    accessories. All the products displayed on E-commerce are
                    100% genuine India made and hand-made.
                  </p>
                  <Link
                    to={"/about-us"}
                          ...
                          {product.map((products, i) => (
                            ...
                            >
                              <div className="rounded-lg overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75">
                                <div
                                  onClick={() => productDetails(products._id)}
                                >
                                  <img
                                ...
                                <HeartIcon
                                  onClick={() =>
                                    wishlistHandler(
                                      Object.hasOwn(wishlist, products._id),
                                      products._id
                                    )
                                  }
                                  className={
                                    Object.hasOwn(wishlist, products._id)
                                      ? " fill-kazari-100 stroke-kazari-100 h5 w-5 bg-transparent absolute right-3 top-3 hover:cursor-pointer"
                                      : " hover:fill-kazari-100 hover:stroke-kazari-100 h5 w-5 bg-transparent absolute right-3 top-3 hover:cursor-pointer"
                                  }
                                />
                              </div>
